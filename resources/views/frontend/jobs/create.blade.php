	...
	<div class="container border-0 bg-none">
		...
		<div class="row">
			...
			<div class="col-12 bg-white pt-3">
				<p class="font-weight-bold">Create Job</p>

				<form class="m-auto" method="POST" action="{{ route('frontend.jobs.store') }}">
					@csrf
					@method('post')
		            ...
		            <div class="mt-4">
		                <div class="form-group row">
		                    ...
		                    <div class="col-sm-10" style="max-width: 445px; margin: auto">
		                        <input name="name" type="text" class="form-control" id="inputJobName" required value="Job1" />
		                    </div>
		                </div>
		            </div>
			        <div class="form-group row">
			        ...
			        <div class="form-group row">
			            ...
			            <div class="col-sm-10" style="max-width: 445px; margin: auto">
			                <input type="number" name="slot" class="form-control" id="inputJobSlot" min="1" required value="1" />
			            </div>
			        </div>
			        <div class="form-group row">
			            <label for="inputJobDesc" class="col-sm-4 col-form-label">Job Description</label>
			            <div class="col-sm-10" style="max-width: 445px; margin: auto">
			                <textarea class="form-control" name="description" id="inputJobDesc" rows="6"></textarea>
			            </div>
			        </div>
			        <div class="form-group row">
